const TEACHER_CODE_HASH = 'a7ca008de03c73b87f94da26a12f06695f657f8dd0e2bcd98f8c61bc5acc17bb';
...
const QUESTION_POOLS = {
  empresa: [
    { q: '¿Qué definición describe mejor a la empresa dentro del módulo?', options: ['Una organización que coordina personas, bienes y recursos financieros para producir bienes o prestar servicios con un fin económico.', 'Un grupo informal de trabajadores que se coordina sin objetivos económicos ni sociales definidos.', 'Una institución pública dedicada exclusivamente a regular el mercado y fijar precios obligatorios.', 'Una actividad individual que no requiere recursos materiales ni organización previa.'], correct: 0 },
    ...
    { q: 'Una empresa pública se caracteriza porque…', options: ['su capital pertenece en todo o en parte al Estado o a una entidad pública con influencia decisiva en la gestión.', 'desarrolla su actividad bajo titularidad estatal o de otra entidad pública, aunque pueda operar en varios ámbitos.', 'debe dedicarse obligatoriamente al sector primario.', 'carece de organización formal y funciona por relaciones espontáneas.'], correct: 0 },
  ...
  organizacion: [
    ...
    { q: 'La jerarquía en una empresa implica…', options: ['el predominio de relaciones espontáneas sin niveles claros de autoridad.', 'existencia de distintos niveles de autoridad y responsabilidad.', 'que solo exista organización informal.', 'que la empresa pertenezca al Estado.'], correct: 1 },
    { q: 'La participación se relaciona con…', options: ['la implicación del personal en propuestas, decisiones y mejoras que afectan a la actividad de la empresa.', 'la prohibición de aportar ideas.', 'la desaparición de las normas internas.', 'el uso exclusivo de rumores como canal de comunicación.'], correct: 0 },
    { q: 'La organización formal…', options: ['surge espontáneamente entre compañeros.', 'se planifica por la dirección para asignar funciones, autoridad y mecanismos de coordinación y control.', 'carece de estructura y autoridad.', 'solo existe en empresas muy pequeñas.'], correct: 1 },
    { q: 'La organización informal…', options: ['solo puede existir en la administración pública.', 'surge de afinidades personales, liderazgo social y grupos espontáneos formados en el trabajo diario.', 'se refleja siempre en el organigrama oficial.', 'sustituye por completo a la organización formal.'], correct: 1 },
    { q: '¿Qué enunciado diferencia mejor organización formal e informal?', options: ['La formal depende de relaciones personales; la informal la define la dirección.', 'La formal fija funciones, autoridad y responsabilidad; la informal nace de relaciones personales y liderazgos espontáneos.', 'La formal solo se usa en empresas industriales; la informal en empresas de servicios.', 'La formal evita toda comunicación; la informal se basa en documentos escritos.'], correct: 1 },
  ...
  funciones: [
    ...
    { q: 'La organización funcional se caracteriza porque…', options: ['cada trabajador puede recibir indicaciones de especialistas distintos según la función concreta que realice.', 'nadie ejerce autoridad sobre nadie.', 'solo sirve para empresas públicas.', 'el organigrama desaparece.'], correct: 0 },
    { q: 'La organización mixta o jerárquico-funcional…', options: ['mantiene la unidad de mando y añade apoyo técnico de especialistas que asesoran a distintos departamentos.', 'elimina el uso de expertos.', 'impide la creación de departamentos.', 'solo puede aplicarse en microempresas.'], correct: 0 },
  ...
  direccion: [
    ...
    { q: 'El nivel intermedio…', options: ['convierte los objetivos generales en planes concretos, coordina departamentos y supervisa su ejecución.', 'sustituye completamente a la alta dirección.', 'carece de responsabilidad sobre personas.', 'se limita a ejecutar tareas manuales.'], correct: 0 },
    ...
    { q: 'En un estilo participativo…', options: ['los empleados obedecen sin opinar.', 'el directivo toma decisiones contando con la colaboración del equipo y equilibrando autoridad y participación.', 'no hay normas ni control.', 'la dirección se delega fuera de la empresa.'], correct: 1 },
    { q: 'El estilo permisivo supone que…', options: ['los empleados actúan con bastante autonomía, aunque dentro de criterios y límites previamente definidos.', 'toda decisión debe ser aprobada por la alta dirección por escrito.', 'se elimina la responsabilidad individual.', 'solo el empresario puede actuar.'], correct: 0 },
    ...
    { q: 'La teoría Y considera que las personas…', options: ['quieren evitar el trabajo y rechazan responsabilidades.', 'pueden implicarse en el trabajo, desarrollarse profesionalmente y asumir responsabilidades con autonomía.', 'solo obedecen si existe castigo.', 'rechazan por naturaleza la creatividad.'], correct: 1 },
    { q: 'La teoría Z destaca, entre otros aspectos…', options: ['búsqueda de consenso en las decisiones, estabilidad laboral y responsabilidad compartida en los resultados.', 'rotación acelerada y promoción inmediata.', 'ausencia de cultura corporativa.', 'prohibición de la participación.'], correct: 0 }
  ],
  informacion: [
    ...
    { q: 'El soporte dentro del sistema de información incluye…', options: ['solo la comunicación oral entre compañeros.', 'equipos físicos y aplicaciones informáticas que permiten registrar, tratar, almacenar y comunicar datos.', 'solamente archivos históricos en papel.', 'solo cláusulas de confidencialidad.'], correct: 1 },
    { q: 'La información confidencial debe protegerse porque…', options: ['carece de valor para la empresa.', 'puede afectar a la empresa si se divulga y por eso solo debe estar disponible para personas autorizadas.', 'solo interesa a competidores extranjeros.', 'debe circular libremente para mejorar rumores.'], correct: 1 },
  ...
  comunicacion: [
    ...
    { q: 'La comunicación interna se produce…', options: ['entre la empresa y sus clientes exclusivamente.', 'entre trabajadores, equipos y departamentos que forman parte de la estructura interna de la empresa.', 'solo en campañas publicitarias.', 'únicamente a través de redes sociales.'], correct: 1 },
    { q: 'Los canales formales y oficiales son…', options: ['los previstos por la empresa para transmitir información de manera oficial, ordenada y conforme a sus normas.', 'las conversaciones espontáneas de pasillo.', 'las amistades surgidas fuera del trabajo.', 'los comentarios anónimos en internet.'], correct: 0 },
    { q: 'Los rumores dentro de la empresa son…', options: ['datos verificables publicados por la dirección.', 'informaciones no confirmadas que circulan entre personas sin pruebas suficientes sobre su veracidad.', 'el principal instrumento de la contabilidad.', 'canales externos de publicidad.'], correct: 1 },
    ...
    { q: 'La cultura corporativa es…', options: ['el sistema de valores, normas y comportamientos compartidos que orienta la forma de actuar de la organización.', 'el número de departamentos existentes.', 'la cuantía del capital social.', 'la clasificación jurídica de la empresa.'], correct: 0 },
    { q: 'Una mala gestión de la comunicación externa puede…', options: ['mejorar automáticamente la reputación.', 'deteriorar la reputación de la empresa y reducir la confianza de clientes y otros públicos.', 'reducir la necesidad de coordinar canales.', 'hacer innecesario el marketing.'], correct: 1 }
  ],
  global: []
};
